...
impl SimpleComponent for AboutDialog {
    ...
    fn init_root() -> Self::Root {
        adw::AboutDialog::builder()
            ...
            // .website("https://gitlab.gnome.org/bilelmoussaoui/gfwd/")
            // Insert your Issues page
            // .issue_url("https://gitlab.gnome.org/World/Rust/gfwd/-/issues")
            // Insert your application name here
            .application_name("Relm4-template")
            .version(VERSION)
            .translator_credits("translator-credits")
            .copyright("© 2024 Enrico Rizzo")
            .developers(vec!["Enrico Rizzo"])
            .designers(vec!["Enrico Rizzo"])
            .build()
    }
